                            ...
                            <tbody>
                              <?php 
                                    ...
                                    while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                             ...
                                             <button type="button" id="deleteCourse" data-id='<?php echo $selCourseRow['cou_id']; ?>'  class="btn btn-danger btn-sm">Borrar</button>
                                            </td>
                                        </tr>
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="2">
                                        <h3 class="p-3">No se ha encontrado ningún curso</h3>
                                      </td>
                                    </tr>
                                <?php }
                               ?>
